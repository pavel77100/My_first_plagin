...
namespace My_first_plagin
{
    ...
    public class Seven_command : IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            ISelectionFilter selFilter = new MassSelectionFilter2();
            ...
            if (coutn_of_array > 0)
            {
                ...
                {
                    String Parameter_select = elem.GetParameters("Объем")[0].AsValueString().Split(' ')[0];
        ...
        public class MassSelectionFilter2 : ISelectionFilter
        {
